                    ...
                    >
                      <span class="flex w-[200px]" @click="isFolderMenuOpen = !isFolderMenuOpen">
                        <svg
                          ...
                          height="16"
                          fill="currentColor"
                          class="bi bi-folder flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                          viewBox="0 0 16 16"
                        >
                          <path
                      ...
                      <span onclick="openFolderModal()" class="text-end">
                        <svg
                          ...
                          height="16"
                          fill="currentColor"
                          class="bi bi-plus-circle-dotted w-6 h-6"
                          viewBox="0 0 16 16"
                        >
                          <path
                    ...
                    >
                      ...
                      >
                        <svg
                          ...
                          height="16"
                          fill="currentColor"
                          class="bi bi-grid-fill flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                          viewBox="0 0 16 16"
                        >
                          <path
                  ...
                  <li @click="setMenu('tools')">
                    ...
                    >
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        class="bi bi-shield-lock w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        viewBox="0 0 16 16"
                      >
                        <path
                  ...
                  <li>
                    ...
                    >
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        class="bi bi-explicit w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        viewBox="0 0 16 16"
                      >
                        <path
